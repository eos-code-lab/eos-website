  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.hr
          className="border-t-4 w-[3%] mx-auto my-4 blue"
          variants={itemVariants}
        />

        <motion.p className="text-black" variants={itemVariants}>
          ASK US FOR AN ESTIMATE
        </motion.p>
        <motion.p className="mb-2 text-black" variants={itemVariants}>
          Tell us about the project you want to bring to life and you will
          receive an estimate that meets your needs and your budget. And your
          imagination!
        </motion.p>
